...
$con= mysqli_connect('egon.cs.umn.edu','C4131F16U131','19383','C4131F16U131','3307');
// Check connection
...
mysqli_query($con,"INSERT INTO tbl_accounts (acc_name, acc_login, acc_password) VALUES ('Jim Smith', 'Smitt', '". sha1($str1)."');");
