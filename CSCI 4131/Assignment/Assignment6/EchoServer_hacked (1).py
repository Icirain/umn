...
def  processreq(req):
  ...
  response_301='{} 301 Move Permanently {}{}{}'.format(req_protocol,CRLF,CRLF,CRLF)
  ...
  if location=='csumn':
    if req_method=='GET':
      return 'location: https://www.cs.umn.edu/'
    else:
      return response_301+CRLF
  if os.path.isfile(location)==False:
    if req_method=='GET':
      return response_404+open_html('404.html')
    else:
      return response_404
